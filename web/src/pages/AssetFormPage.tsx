...
function parseCHF(
  ...
  if (
    ...
    throw new Error(
      "Neupreis enthält keinen gültigen CHF-Betrag "
      + "(z. B. CHF 100.-).",
    );
  }
  ...
  if (
    ...
    throw new Error(
      "Neupreis darf nicht negativ sein.",
    );
  }
...
export default function AssetFormPage({
    ...
    () => {
      async function loadForm(): Promise<void> {
        ...
        try {
          ...
          const formPayload: unknown =
            await formResponse.json();

          const metaPayload: unknown =
          ...
          if (
            ...
            let message =
              "Die Stammdaten für den neuen Eintrag "
              + "konnten nicht geladen werden.";

            if (
              typeof formPayload === "object"
              && formPayload !== null
              && "detail" in formPayload
              && typeof (
                formPayload as {
                  detail?: unknown;
                }
          ...
          if (
            ...
            throw new Error(
              "Status- und Zustandsinformationen "
              + "konnten nicht geladen werden.",
            );
          }
          ...
          const data =
            formPayload as FormDataResponse;
          ...
          setErrorMessage(
            error instanceof Error
              ? error.message
              : "Die Eingabedaten konnten nicht geladen werden.",
          );
  ...
  function handleModelModeChange(
    value: ModelMode,
  ): void {
    setModelMode(
      value,
  ...
  function buildPayload():
    ...
    if (!formData) {
      throw new Error(
        "Die Stammdaten sind noch nicht geladen.",
      );
    }
  ...
  const selectedModelManufacturer =
    selectedModel
      ? (
        manufacturersById.get(
          idText(
            selectedModel
              .manufacturer_id,
          ),
  ...
  const modelSpecifications =
    selectedModel
    && typeof selectedModel.specifications
      === "object"
        ...
        <div className="asset-form-columns">
          ...
          <div className="asset-form-column">
              ...
              <div className="asset-form-row">
                ...
                >
                  ...
                  <option value="existing">
                    Vorhandenes Produktmodell verwenden
                  </option>
                  ...
                  <div className="asset-form-row">
                    ...
                    >

                      {
                        ...
                        && (
                          <option value="">
                            Kein aktives Produktmodell vorhanden
                          </option>
                        )
                      }
                    ...
                    <div className="asset-form-info-box">

                      {
                        selectedModel
                          ...
                          : (
                            <span>
                              Für diese Artikelart ist
                              noch kein aktives Produktmodell
                              vorhanden. Wähle
                              „Neues Produktmodell anlegen“.
                            </span>
                          )
            ...
            <fieldset className="asset-form-group">
              ...
              {
                currentSpecificationFields
                  .length === 0
                && (
                  <div className="asset-form-empty-info">
                    Für diese Kategorie sind keine
                    Spezifikationsfelder definiert.
                  </div>
                )
              }
              ...
              {
                currentSpecificationFields.map(
                  (field) => {
                    const key =
                      specKey(
                        field,
